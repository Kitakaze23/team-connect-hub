      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-2">
        ...
        {filtered.map((contact, i) => (
          <motion.div
            ...
            className="flex items-center gap-3 p-3 rounded-xl bg-card border border-border cursor-pointer hover:border-accent/30 transition-all"
          ...
          >
            ...
            <div className="flex gap-2 shrink-0">
              {contact.phone && (
                <a href={`tel:${contact.phone}`} onClick={e => e.stopPropagation()} className="text-muted-foreground hover:text-accent transition-colors">
